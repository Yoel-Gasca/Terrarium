...
// Funcion para establecer posiciones en el terrario
function dragElement(terrariumElement){
    // Define 4 posiciones para poner en pantalla
    let pos1 = 0, 
        pos2 = 0, 
        pos3 = 0,
        pos4 = 0;
    terrariumElement.onpoointerdown = pointerDrag;

    // controla el comportamiento de la interfaz
    function pointerDrag(e) {
        e.preventDefault();
        console.log(e);
        pos3 = e.clientX;
